...
## In order to run the full system, please download the docker-compose.yaml file and run docker compose up -d in the directory that the compose file is located.
